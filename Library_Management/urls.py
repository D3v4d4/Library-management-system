...
urlpatterns = [
    ...
    path("change-password-student/",student_change_password, name="student_change_password"),
    path("change-password-admin/", admin_change_password, name="admin_change_password"),
